...
public class FireSystem extends Application {
   ...
   // StringBuilder enterdPassword = new StringBuilder();
    ...
    private void switchBackground(/*StackPane pane, ImageView backgroundView, ImageView backgroundFireView*/) {
        ...
        if (backgroundFireView != backgroundView){
        if (isFireBackground) {
    ...
    private void mainScene() {
        ...
        sclience_b.setMinSize(250, 50);
        sclience_b.setLayoutX(width - 240);
        ...
        usernameLabel.setLayoutX(50);  // Set X position
        usernameLabel.setLayoutY(200); // Set Y position
    ...
    private Scene loginScene(Scene settingsScene) {
        ...
        loginButton.setOnAction(e -> {
            ...
            if (username.length() == 0 && password.length() == 0) {
                ...
                System.out.println(enterdPassword.toString().equals("1234"));
                                System.out.println(enterdPassword.toString());

                if(enterdPassword.toString().equals("1234")) 
